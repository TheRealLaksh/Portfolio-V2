...
import profileImg from '../../assets/images/laksh.pradhwani.webp'; // Ensure this image is in the correct folder

const About = () => {
  return (
    <section id="about" className="my-16 sm:my-24 scroll-mt-20" data-aos="fade-up">
      <div className="w-full px-6 md:px-12 relative z-10">

        <h2 className="section-title text-3xl font-bold text-white text-center mb-16 relative">
          About Me
        </h2>
        ...
        <div className="flex flex-col lg:flex-row items-stretch justify-center gap-12 max-w-[1600px] mx-auto">
          ...
          {/* Left: Image */}
          <div className="relative w-full lg:w-1/2 h-[400px] sm:h-[500px] lg:h-auto rounded-2xl overflow-hidden shadow-2xl group order-1">
            <img 
              src={profileImg} 
